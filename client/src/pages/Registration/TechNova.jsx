...
const TechNova = () => {
  ...
  return (
    <div className=' flex flex-col justify-between h-screen'>
      ...
      <h1 className=' uppercase font-Android_Assassin text-slate-100/95 text-center text-2xl sm:mt-5'>Tech Nova</h1>
        ...
        <div className='flex flex-col justify-center items-center gap-0 md:flex-row sm:w-[35rem] bg-slate-400/10 backdrop-filter backdrop-blur border border-slate-400/20 rounded-xl h-fit my-10 sm:mx-0 w-[22rem]'>
          <div className=' sm:w-fit p-14 sm:p-0 flex justify-center items-center'>
            <form onSubmit={handleSubmit} className="flex justify-center items-center flex-col sm:inline-block">
              ...
              <div className="mb-5">
                <label htmlFor="name" className="block mb-2 text-sm font-medium text-slate-100 font-Android_Assassin uppercase">Title</label>
                <input autoComplete='off' type="text" className=" bg-slate-800/30 border border-slate-400/20 p-3 rounded-lg focus:outline-none focus:ring focus:ring-slate-400/30 w-80 md:w-full focus:bg-slate-800/30 text-slate-100 text-base" onChange={e => setTitle(e.target.value)} placeholder='Title'/>
              </div>

              <div className="mb-5">
                <label htmlFor="name" className="block mb-2 text-sm font-medium text-slate-100 font-Android_Assassin uppercase">Domain</label>
                <Dropdown placeHolder={'Select Domain...'} Options={options} onChangeDomain={e => {setDomain(e.value)}}/>
              </div>

              <div className="mb-5">
                <label htmlFor="name" className="block mb-2 text-sm font-medium text-slate-100 font-Android_Assassin uppercase">Abstract</label>
                <textarea autoComplete='off' type="text" className=" bg-slate-800/30 border border-slate-400/20 p-3 rounded-lg focus:outline-none focus:ring focus:ring-slate-400/30 w-80 md:w-full focus:bg-slate-800/30 text-slate-100 text-base" onChange={e => setAbstract(e.target.value)} placeholder='Abstract'/>
              </div>
