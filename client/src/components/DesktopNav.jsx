        ...
        <nav className=' flex justify-between items-center'>
            ...
            <div className=" hidden sm:block">
                <ul className=' flex justify-center items-center flex-wrap'>
                    ...
                    <li><Link to="/technovation/sponsors" className={active === "sponsors" ? ` mx-7 font-Android_Assassin not-italic font-normal text-base text-slate-100 hover:text-[#A6C7D0] border-b-white border-b-2 tracking-wide pb-1` : ` mx-7 font-Android_Assassin not-italic font-normal text-base text-[#A6C7D0] hover:text-slate-100 tracking-wide pb-1`}>Our Sponsors</Link></li>
                </ul>
            </div>
